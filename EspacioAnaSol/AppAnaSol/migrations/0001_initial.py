# Generated by Django 5.0.6 on 2024-11-03 14:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.MaxLengthValidator(255)])),
                ('apellido', models.CharField(blank=True, max_length=255, null=True, validators=[django.core.validators.MaxLengthValidator(255)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_turno', models.CharField(choices=[('reservado', 'Reservado'), ('disponible', 'Disponible'), ('no_disponible', 'No Disponible')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Caja',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_reserva', models.CharField(choices=[('Confirmada', 'Confirmada'), ('En Proceso', 'En Proceso'), ('Cancelada', 'Cancelada')], default='En Proceso', max_length=20)),
        ...
        migrations.CreateModel(
            name='D_VentaXServicio',
            fields=[
                ('id_d_vent_x_serv', models.AutoField(primary_key=True, serialize=False)),
                ('id_d_venta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppAnaSol.detalleventa')),
        ...
        migrations.AddField(
            model_name='reservas',
            name='id_serv_x_tur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppAnaSol.servicioxturno'),
        ),
        migrations.CreateModel(
            name='EmpleadoXTurno',
            fields=[
        ...
        migrations.AddField(
            ...
            name='id_venta',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppAnaSol.venta'),
        ),
    ]
