...
class Cliente(models.Model):
    ...
    correo_electronico = models.CharField(max_length=255, validators=[EmailValidator()])
...
class Reservas(models.Model):
    ...
    estado_reserva = models.CharField(max_length=20, choices=ESTADO_OPCIONES, default='en_proceso')

    def __str__(self):
        return f'Reserva {self.id_reserva} - Cliente: {self.id_cliente.nombre}'
